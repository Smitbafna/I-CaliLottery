...
import {
  ...
  ContractProposal,
  Members,
  TransferPrizeRequest,PurchaseTicketRequest,
} from '../contractApi';
...
export class ContextApiDataSource implements ContractApi {
  ...
  async transferPrize(
    ...
    try {
      ...
      const apiEndpoint = `${getStorageAppEndpointKey()}/admin-api/contexts/${jwtObject.context_id}/lottery/transfer-prize`;
      const body = request;
  ...
  async purchaseTicket(
    ...
    try {
      ...
      const apiEndpoint = `${getStorageAppEndpointKey()}/admin-api/contexts/${jwtObject.context_id}/lottery/purchase-ticket`;
      const body = request;
