...
export const Navbar = () => {
  ...
  <NavbarContent className="flex justify-center gap-14">
    ...
    <NavbarItem>
      <Link href="/commit" className="text-lg font-bold text-black hover:text-gray-700">
      Commit
      </Link>
    </NavbarItem>
    <NavbarItem>
    ...
    <NavbarItem>
      <Link href="/reveal" className="text-lg font-bold text-black hover:text-gray-700">
        Reveal
      </Link>
    </NavbarItem>
    <NavbarItem>
      <Link href="/winner" className="text-lg font-bold text-black hover:text-gray-700">
        Winner
      </Link>
    </NavbarItem>
  </NavbarContent>
